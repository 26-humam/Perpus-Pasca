            ...
            <nav class="teal darken-2">
                <div class="container">
                        ...
                        <div class="nav-wrapper">
                            <a href="<?php echo base_url();?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/logog.png" width="45px" alt="logo" ></a>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img z-depth-0" width="200px" src="<?php echo base_url(); ?>assets2/img/logog.png" alt="" srcset="">
        </div>
        <h3 class="header center white-text text-lighten-2 z-depth-0">PERPUSTAKAAN PASCA SARJANA <br>UIN SGD BANDUNG</h3>
  ...
  <!-- Slider end -->
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ICT &copy; : <a href="https://www.google.com/" target="_blank">Pascasarjana UIN SGD Bandung</a>
                </div>
